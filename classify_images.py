...
def classify_images(images_dir, results_dic, model):
    ...
    # classify each item in the results dictionary
    
    for key, value in results_dic.items():

        # full filepath to image
        ...
        # add classification to dictionary
        
        classified_dic = [image_classification, image_match]
        
        results_dic[key].extend(classified_dic)
